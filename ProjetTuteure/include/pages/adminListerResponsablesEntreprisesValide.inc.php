...
<h1 class="font-weight-light">Liste des responsables d'entreprises validés</h1>
<br>
<?php
$pdo = new Mypdo();
$managerRespEnt = new ResponsableEntrepriseManager($pdo);
$managerPersonne = new PersonneManager($pdo);
$listeResponsables = $managerRespEnt->getListeResponsableEntrepriseMasques();
...
{?>
    <div id="aucunReponsable" class="col-md-8 ml-auto mr-auto mt-3 shadow-lg p-3 mb-5 rounded">
        <h5 class="font-weight-light"> Il n'y a aucun responsable d'entreprise validé.</h5>
    </div>
<?php
}
?>
<script type="text/javascript" src="./js/listerResponsableEntrepriseValide.js"></script>

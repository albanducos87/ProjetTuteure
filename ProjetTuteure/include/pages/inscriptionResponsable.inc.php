<div class="container font-weight-light pb-5">
	...
	?>
		...
		<form id="formulaireinscriptiontout" class="col col-md-10 m-auto shadow-lg p-3 mb-5 rounded" action="index.php?page=4" method="post">
	...
	<?php
			...
			if($_POST["inputMdp"] != $_POST["inputMdp2"]){
				...
				if($verifMail == true){
					...
					$personneManager->inscriptionRes($_POST["inputNom"],$_POST["inputPrenom"],$_POST["inputTel"],$_POST["inputMail"],$_POST["inputMdp"],$_POST["inputDate"]);

					$idReponsableEtu = $personneManager->getIdByLogin($_POST["inputMail"]);

					$responsableEtudiantManager->insertResponsableEtu($idReponsableEtu,$_POST["etablissement"]);

...
valider.addEventListener('click',function(){
	...
	let casesValides = new Array();
		...
		while (i< casesValides.length) {
			href = href + "&" + "idRespEnt" + String(i) + "=" + String(casesValides[i]);
			i = i+1;
		}
		href = href + "&nbRespEnt=" + i;
		valider.href = "index.php?page=39" + href;
	});
...
supprimer.addEventListener('click',function(){
	...
	let casesValides = new Array();
		...
		href = href + "&nbRespEnt=" + i;
		document.location.href="index.php?page=40" + href;
	}
	});
});